...
public class Main extends JavaPlugin {
    ...
    private void loadMessages()
    {
        ...
        this.addDefault(defaults, Messages.ENABLE, "$7 You have $a$nenabled$7 FriendlyFire.", null);
        this.addDefault(defaults, Messages.DISABLE, "$7 You have $c$ndisabled$7 FriendlyFire.", null);
